...
class Cookies: UIViewController {
    private let cookiesImageView: UIImageView = {
        let imageView = UIImageView()
        imageView.image = UIImage(named: "group10")
    ...
    override func viewDidLoad() {
        ...
        view.addSubview(cookiesImageView)
        ...
        NSLayoutConstraint.activate([
            cookiesImageView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor),
            cookiesImageView.leadingAnchor.constraint(equalTo: view.leadingAnchor),
            cookiesImageView.trailingAnchor.constraint(equalTo: view.trailingAnchor),
            cookiesImageView.bottomAnchor.constraint(equalTo: questionButton.topAnchor, constant: -10),
