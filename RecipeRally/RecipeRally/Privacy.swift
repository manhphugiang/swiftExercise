...
class Privacy: UIViewController {
    private let privacyImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "group8")
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            privacyImageView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor),
            privacyImageView.leadingAnchor.constraint(equalTo: view.leadingAnchor),
            privacyImageView.trailingAnchor.constraint(equalTo: view.trailingAnchor),
            privacyImageView.bottomAnchor.constraint(equalTo: questionButton.topAnchor, constant: -10),
