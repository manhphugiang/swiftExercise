...
class Contact: UIViewController {
    private let contactImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "group11")
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            contactImageView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor),
            contactImageView.leadingAnchor.constraint(equalTo: view.leadingAnchor),
            contactImageView.trailingAnchor.constraint(equalTo: view.trailingAnchor),
            contactImageView.bottomAnchor.constraint(equalTo: navBarContainer.topAnchor),
