...
class Account: UIViewController {
    private let accountImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "group12")
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            accountImageView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor),
            accountImageView.leadingAnchor.constraint(equalTo: view.leadingAnchor),
            accountImageView.trailingAnchor.constraint(equalTo: view.trailingAnchor),
            accountImageView.bottomAnchor.constraint(equalTo: questionButton.topAnchor, constant: -10),
